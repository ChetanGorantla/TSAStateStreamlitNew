...
st.write(filtered_data[['medication_name', 'start_date', 'end_date']])
...
if st.button("Add"):
    med_data = med_data.append({'medication_name': name, 'start_date': start_date, 'end_date': end_date}, ignore_index=True)
